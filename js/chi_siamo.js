...
if (check == true) {
  ...
  class_name = "carica_101_images_mobile";
  dot_name = "dot_mobile";
} else {
  document.getElementById('computer_version').style.display = "block";
  class_name = "carica_101_images_computer";
  dot_name = "dot_computer";
}
